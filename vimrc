...
au BufNewFile,BufRead,BufEnter vimrc map <silent> <leader>v :w <CR>:source ~/.vimrc<CR>:filetype detect<CR>!git commit -am 'update vim'<CR> :exe ":echo 'vimrc reloaded'"<CR>
au BufNewFile,BufRead,BufEnter .vimrc map <silent> <leader>v :w <CR>:source ~/.vimrc<CR>:filetype detect<CR>!git commit -am 'update vim'<CR> :exe ":echo 'vimrc reloaded'"<CR>
